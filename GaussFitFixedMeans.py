...
with open('./GNUData/GNU3DeutHD.txt',"r") as f:
	data = f.readlines()
...
def Gauss2(x,A,sig1,B,sig2):
	return A*np.exp(-(x-c[1])**2/(2*sig1**2))+B*np.exp(-(x-c[2])**2/(2*sig2**2))

def Gauss3(x,A,sig1,B,sig2,C,sig3):
	return A*np.exp(-(x-c[1])**2/(2*sig1**2))+B*np.exp(-(x-c[2])**2/(2*sig2**2))+C*np.exp(-(x-c[3])**2/(2*sig3**2))

def Gauss4(x,A,sig1,B,sig2,C,sig3,D,sig4):
	return A*np.exp(-(x-c[1])**2/(2*sig1**2))+B*np.exp(-(x-c[2])**2/(2*sig2**2))+C*np.exp(-(x-c[3])**2/(2*sig3**2))+D*np.exp(-(x-c[4])**2/(2*sig4**2))

def Gauss5(x,A,sig1,B,sig2,C,sig3,D,sig4,E,sig5):
	return A*np.exp(-(x-c[1])**2/(2*sig1**2))+B*np.exp(-(x-c[2])**2/(2*sig2**2))+C*np.exp(-(x-c[3])**2/(2*sig3**2))+D*np.exp(-(x-c[4])**2/(2*sig4**2))+E*np.exp(-(x-c[5])**2/(2*sig5**2))
...
if 4 in numGauss:
	...
	upperbounds = [2,0.5,2,0.5,2,0.5,2,0.5]
...
if 5 in numGauss:
	...
	upperbounds = [2,1,2,1,2,1,2,1,2,1]
